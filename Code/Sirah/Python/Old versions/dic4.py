...
def fill_conditions(line_array):
    if len(line_array) == 4:
        ...
        filename = "/home/pi/Desktop/Sirah/Logs/Dades/log.csv"
...
def sirah(current_kc, df):
    ...
    df0 = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Encesa/date.csv', header = None)
...
def via(option, date):
    if option == 1:
        df_crop = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Cultius/Tomato.csv')
    elif option == 2:
        df_crop = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Cultius/Lettuce.csv')
    elif option == 3:
        df_crop = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Cultius/Jew.csv')
...
def compute_geqi(df_geqi):
    ...
    df_prevgeqi = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Geqi/geqi.csv')['geqi']
    ...
    if int(current_min) == 33 and int(current_s) == 00 and prev_geqi != geqi :
        with open('/home/pi/Desktop/Sirah/Logs/Geqi/geqi.csv', 'a', newline='') as f_object:
            writer_object = writer(f_object)
...
while(True):
    ...
    df0 = pd.read_csv('/home/pi/Desktop/Sirah/Auxiliars/ControlData/date.csv', header = None)
    date0 = date_format(df0)

    df = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Encesa/date.csv')

    df1 = pd.read_csv('/home/pi/Desktop/Sirah/Auxiliars/ControlData/day1.csv', header = None)
    date1 = date_format(df1)

    df2 = pd.read_csv('/home/pi/Desktop/Sirah/Auxiliars/ControlData/day2.csv', header = None)
    date2 = date_format(df2)

    df3 = pd.read_csv('/home/pi/Desktop/Sirah/Auxiliars/ControlData/day3.csv', header = None)
    date3 = date_format(df3)

    df4 = pd.read_csv('/home/pi/Desktop/Sirah/Auxiliars/ControlData/day4.csv', header = None)
    date4 = date_format(df4)

    type1 = "/home/pi/Desktop/Sirah/Auxiliars/Cultius/type1.txt"
    type2 = "/home/pi/Desktop/Sirah/Auxiliars/Cultius/type2.txt"
    type3 = "/home/pi/Desktop/Sirah/Auxiliars/Cultius/type3.txt"
    type4 = "/home/pi/Desktop/Sirah/Auxiliars/Cultius/type4.txt"
    ...
    filename1 = "/home/pi/Desktop/Sirah/Auxiliars/Via/via1.csv"
    via_fill(filename1, option1, current_day1, current_kc1, remaining1, progress1)
    filename1ETc = "/home/pi/Desktop/Sirah/Auxiliars/Etc/ETc1.csv"
    evapo_fill(filename1ETc, ETc1)

    filename2 = "/home/pi/Desktop/Sirah/Auxiliars/Via/via2.csv"
    via_fill(filename2, option2, current_day2, current_kc2, remaining2, progress2)
    filename2ETc = "/home/pi/Desktop/Sirah/Auxiliars/Etc/ETc2.csv"
    evapo_fill(filename2ETc, ETc2)

    filename3 = "/home/pi/Desktop/Sirah/Auxiliars/Via/via3.csv"
    via_fill(filename3, option3, current_day3, current_kc3, remaining3, progress3)
    filename3ETc = "/home/pi/Desktop/Sirah/Auxiliars/Etc/ETc3.csv"
    evapo_fill(filename3ETc, ETc3)

    filename4 = "/home/pi/Desktop/Sirah/Auxiliars/Via/via4.csv"
    via_fill(filename4, option4, current_day4, current_kc4, remaining4, progress4)
    filename4ETc = "/home/pi/Desktop/Sirah/Auxiliars/Etc/ETc4.csv"
    evapo_fill(filename4ETc, ETc4)

    #df_geqi = pd.read_csv('/home/pi/Descargas/geqi - Full 1.csv')
    #df_geqi = pd.read_csv('/home/pi/Desktop/Sirah/Logs/Dades/log.csv')
    df_geqi = pd.read_csv('/home/pi/Desktop/Antic/log.csv')
